...
void colorWipe(int r, int g, int b, int wait) {
  ...
  for(int i=0; i<strip.numPixels(); i++) {
    ...
    strip.setPixelColor(32-i, r, g, b);
     strip.setPixelColor(33-1, randr1, randg1, randb1);
     strip.setPixelColor(34-i, randr2, randg2, randb2);
     strip.setPixelColor(35-i, randr3, randg3, randb3); // add more of these lines to make the trail longer
      strip.show();
      delay(wait);
