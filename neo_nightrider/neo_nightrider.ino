...
void colorWipe(int r, int g, int b, int wait) {
  for(int i=0; i<strip.numPixels(); i++) {
    ...
    strip.setPixelColor(i, r, g, b);
     strip.setPixelColor(i-1, randr1, g, b);
     strip.setPixelColor(i-2, randr2, g, b);
     strip.setPixelColor(i-3, randr3, g, b); // add more of these lines to make the trail longer
      strip.show();
      delay(wait);
  ...
  for(int i=0; i<strip.numPixels(); i++) {
    ...
    int randb3 = b -(20*bright);
    if (randb3 < 1) randb3 = 1 + bright;
    strip.setPixelColor(32-i, r, g, b);
     strip.setPixelColor(33-1, randr1, g, b);
     strip.setPixelColor(34-i, randr2, g, b);
     strip.setPixelColor(35-i, randr3, g, b); // add more of these lines to make the trail longer
      strip.show();
      delay(wait);
      strip.setPixelColor(36-i, strip.Color(0,0,0)); // make sure the i-number is the amount of the trail
      strip.show();
      delay(wait);   
}  
}
